...
export function ProductForm({
  ...
  const handleSubmit = async (data: CreateProduct | UpdateProduct) => {
    try {
      ...
      console.error(`Error ${mode}ing product:`, _error);
      toast.error(
        _error instanceof Error ? _error.message : `Failed to ${mode} product`
      );
    } finally {
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Complete product description with features, benefits,
                          and details
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            ...
                            <FormDescription>
                              This product is delivered digitally (no shipping
                              required)
                            </FormDescription>
                          </div>
                          <FormControl>
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            ...
                            <FormDescription>
                              This physical product needs to be shipped to
                              customers
                            </FormDescription>
                          </div>
                          <FormControl>
                ...
                <CardContent className="space-y-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          This will be the URL path: /products/
                  ...
                  <div className="space-y-3">
                    ...
                    {loadingCategories ? (
                      ...
                      <div className="grid max-h-48 grid-cols-1 gap-3 overflow-y-auto md:grid-cols-2">
